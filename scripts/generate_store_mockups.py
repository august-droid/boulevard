...
def make_background(w, h, accent=ACCENT_PURPLE) -> Image.Image:
    ...
    glow = radial_glow((w, h), accent, intensity=130, radius_ratio=0.7)
    offset = Image.new("RGBA", (w, h), (0, 0, 0, 0))
    offset.alpha_composite(glow, dest=(0, -int(h * 0.18)))
    base.alpha_composite(offset)
    glow2 = radial_glow((w, h), accent, intensity=60, radius_ratio=0.5)
...
def build_screenshot(
    ...
    # Headline
    headline_size = int(canvas_w * 0.085)
    ...
    if sub_line:
        ...
        draw_centered_text(d, sub_line, end_y + 18, fnt_sub, fill=DIM_WHITE, canvas_w=canvas_w)
...
SCREENSHOT_SPECS = [
    {
        "name": "1_made_for_you",
        "headline": ["MUSIC MADE", "JUST FOR YOU"],
        "sub": "Personal songs, generated by AI.",
        "screen": "for_you",
        "accent": ACCENT_PURPLE,
    },
    {
        "name": "2_tell_your_vibe",
        "headline": ["TELL US", "YOUR VIBE"],
        "sub": "Mood in. Music out.",
        "screen": "vibe_grid",
        "accent": ACCENT_BLUE,
    },
    {
        "name": "3_seconds",
        "headline": ["YOUR SONG IN", "SECONDS"],
        "sub": "AI builds your mix on demand.",
        "screen": "generating",
        "accent": ACCENT_GREEN,
    },
    {
        "name": "4_endless_mixes",
        "headline": ["ENDLESS", "PERSONAL MIXES"],
        "sub": "Never hear the same song twice.",
        "screen": "player",
        "accent": ACCENT_PINK,
    },
    {
        "name": "5_your_taste",
        "headline": ["LEARNS WHAT", "YOU LOVE"],
        "sub": "The more you listen, the better it gets.",
        "screen": "library",
        "accent": ACCENT_AMBER,
    },
    {
...
def generate_feature_graphic():
    ...
    d.text((420, 130), "BOULEVARD", font=fnt_word, fill=WHITE)
    fnt_tag = font(34, bold=False)
    d.text((422, 230), "AI music, made for you.", font=fnt_tag, fill=(220, 220, 225))
